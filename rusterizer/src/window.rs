...
impl Window {
    pub fn new(name: String, width: usize, height: usize) -> Self {
        ...
        options.resize = true;
        let window = minifb::Window::new(name.as_str(), width, height, options)
    ...
    pub fn display(&mut self) {
        ...
        self.window
            .update_with_buffer(&self.frame_buffer.data, width, height)
            .expect("Failed to display frame buffer.");
