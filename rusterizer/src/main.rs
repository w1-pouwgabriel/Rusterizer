...
fn main() {
    ...
    let triangle = Triangle::new(glam::vec2(150.0, 150.0), glam::vec2(370.0, 300.0), glam::vec2(480.0, 150.0));
    ...
    while !window.should_close() {
        ...
        for i in 0..window.frame_buffer().get_data().len(){
            ...
            let bary = barycentric_coordinates(coords, triangle.v0, triangle.v1, triangle.v2, area);
